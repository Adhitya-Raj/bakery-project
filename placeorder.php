...
<body onload="formFill()">
  ...
  <div class="container content-body text-center">
    <h1>Order Details</h1>
    <form name="myCart" action="#" method="post">
      ...
      <table class="form-table">
        ...
        <tr>
          <td>Note to Chef:</td>
          <td> <textarea class="cart" rows="1" name="note" readonly></textarea> </td>
        </tr>
        <tr>
          <td>Total Cost:</td>
      ...
      <table class="form-table">
        <tr>
          <td>Customer Name:</td>
          <td><input class="cart" type="text" name="custName" placeholder="Your Name"></td>
        </tr>
        <tr>
          <td>Phone Number:</td>
          <td><input class="cart" type="text" name="phoneNo" placeholder="9876543210"></td>
        </tr>
        <tr>
          <td>Customer Address:</td>
          <td><textarea class="cart" name="addr" placeholder="Full address"></textarea></td>
        </tr>
      </table>
